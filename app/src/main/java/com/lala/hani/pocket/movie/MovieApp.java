package com.lala.hani.pocket.movie;
...
public class MovieApp {
    ...
    public static String ACTION_LoadComplete ="com.lan.movie.LoadComplete";
    public static String ACTION_LoadMovieInfoComplete ="com.lan.movie.LoadSummaryComplete";
